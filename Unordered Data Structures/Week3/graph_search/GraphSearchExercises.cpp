...
int GridGraph::countEdges() const {
  ...
  // TODO: Your code here!
  // =======================================================================
  numEdges=count_undirected_edges/2;
  return numEdges;
}
...
void GridGraph::removePoint(const IntPair& p1) {
  ...
  for(auto neighbour_iter=originalNeighbors.begin();neighbour_iter!=originalNeighbors.end();neighbour_iter++){
    removeEdge(*neighbour_iter,p1);
  }
